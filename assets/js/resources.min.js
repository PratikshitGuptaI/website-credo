...
if (loc === 'cloudnowtech.com' || loc === 'www.cloudnowtech.com') {
  gasCaseStudyURL =
    'https://script.google.com/macros/s/AKfycbzzjUoPEB1Pv5f9eUWdZkgM-5V7nrA7XdhtPpVf2-FMyX8Z-a_qm5vkaqjXSxRWl9TT/exec';
} else {
  gasCaseStudyURL =
    'https://script.google.com/macros/s/AKfycbzzjUoPEB1Pv5f9eUWdZkgM-5V7nrA7XdhtPpVf2-FMyX8Z-a_qm5vkaqjXSxRWl9TT/exec';
}
...
$(document).ready(function() {
  $('#contactModal .remove').click(function() {
    setTimeout(function() {
      $('#contactModal').remove();
    }, 400);
  });
...
// contactModal Popup show
$(window).scroll(function() {
  const hT = $('#services').offset().top;
  const hH = $('#services').outerHeight();
  const wH = $(window).height();
  const wS = $(this).scrollTop();
  // eslint - disable - next - line no - console
  console.log(hT - wH, wS);
  if (wS > hT + hH - wH) {
    $('.casestydy-page .main, .casestydy-page .header').addClass('blur');
    setTimeout(function() {
...
// Case Study type
const cardiologyCaseStudy = 'cardiology-practice-custom-application';
const financialCaseStudy = 'financial-firm-merchant-on-boarding';
const insuranceCaseStudy = 'insurance-brokerage-statutory-compliance';
const luxuryCaseStudy = 'luxury-retailers-continuous-integration';
const tyreCaseStudy = 'tyre-manufacturer-custom-application';
const elmsCaseStudy = 'enhanced-lms-operations-and-scalability';
let caseStudyName;

$('#cardiologyBtn').click(function() {
  caseStudyName = cardiologyCaseStudy;
});
$('#financialBtn').click(function() {
  caseStudyName = financialCaseStudy;
});
$('#insuranceBtn').click(function() {
  caseStudyName = insuranceCaseStudy;
});
$('#luxuryBtn').click(function() {
  caseStudyName = luxuryCaseStudy;
});
$('#tyreBtn').click(function() {
  caseStudyName = tyreCaseStudy;
});
$('#elmsBtn').click(function() {
  caseStudyName = elmsCaseStudy;
});
...
$('#casestudyForm').validate({
  ...
  submitHandler() {
    $('#contactModal .cantact-submit').html(
      "<i class='fa fa-circle-o-notch fa-spin'></i> Submitting",
    );
    $('#contactModal .cantact-submit').attr('disabled', 'disabled');

    const caseStudyEmail = $('#caseStudyEmail')
      .val()
      .trim();
    const caseStudy = caseStudyName;

    const formData = new FormData();
    formData.append('Email', caseStudyEmail);
    formData.append('Case Study', caseStudy);
    ...
    $.ajax({
      ...
      data: formData,
      success() {
        $('#contactModal .cantact-submit').html('send');
        $('#contactModal .cantact-submit').removeAttr('disabled');
        // window.location.replace('../thank-you.html');
        swal('Thanks', 'You can now access the full case study.', 'success').then(() => {
          document.getElementById('casestudyForm').reset();
          $('#contactModal').modal('hide');
          $('.casestydy-page .main, .casestydy-page .header')
            .removeClass('blur')
            .addClass('noblur');
          setTimeout(function() {
            $('#contactModal').remove();
